...
public class CreatureTagManager
{
    ...
    //private Dictionary<CreatureTag, List<Creature_OLD>> teamsAndMembersDictionary;
    ...
    //        teamsAndMembersDictionary.Add(tag, new List<Creature_OLD>());
    //}

    //public CreatureTagManager()
    //{
    //    teamsAndMembersDictionary = new Dictionary<CreatureTag, List<Creature_OLD>>();
    //    teamsAndMembersDictionary.Add(_noTag, new List<Creature_OLD>());
    //}

    //public void add(CreatureTag tag, Creature_OLD creature)  // associates the tag and creature 
    //{
    //    if (!tagExists(tag))
    //        teamsAndMembersDictionary[tag] = new List<Creature_OLD>();
    ...
    //public bool changeTag(CreatureTag newTag, Creature_OLD creature)  // attempts to change the tag for this creature if it exists
    //{
    //    // don't change tag
    ...
    //public bool removeCreature(Creature_OLD creature) // true: was removed, false otherwise
    //{
    ...
    //    List<Creature_OLD> list = teamsAndMembersDictionary[tag];
